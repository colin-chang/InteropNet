...
{
    public static class Interoptor
    {
        ...
        private static string GetAssemblyName(Type interfaceType) =>
            $"InteropRuntimeImplementer.{GetSubstantialName(interfaceType)}Instance";

        private static string GetImplementationTypeName(string assemblyName, Type interfaceType) =>
            $"{assemblyName}.{GetSubstantialName(interfaceType)}Implementation";
        ...
        private static string GetDelegateName(string assemblyName, MemberInfo methodInfo) =>
            $"{assemblyName}.{methodInfo.Name}Delegate";
